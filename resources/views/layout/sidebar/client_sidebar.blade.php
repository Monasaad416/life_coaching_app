			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							{{-- <img alt="user-img" class="avatar avatar-xl brround" src="{{asset('uploads/clients')."/".auth('admin')->user()->photo }}" ><span class="avatar-status profile-status bg-green"></span> --}}
						</div>
						<div class="user-info">
                            @if(Auth::guard('client')->check())
                            	<h4 class="font-weight-semibold mt-3 mb-0">{{Auth::guard('client')->user()->name}}</h4>
							    <span class="mb-0 text-muted">{{Auth::guard('client')->user()->email}}</span>
                            @endif
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('client.category.index')}}">{{trans('admin.categories_list')}}</a></li>
						</ul>
					</li>
					<li class="slide">
					...
					{{-- <li class="side-item side-item-category">{{ trans('admin.users') }}</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='mail-compose') }}">{{ trans('admin.clientes')}}</a></li>
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M13 4H6v16h12V9h-5V4zm3 14H8v-2h8v2zm0-6v2H8v-2h8z" opacity=".3"/><path d="M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg><span class="side-menu__label">{{ trans('admin.clientes')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('client.edit_profile') }}">{{trans('admin.update_profile')}}</a></li>
						</ul>
					</li>
					<li class="slide ">
