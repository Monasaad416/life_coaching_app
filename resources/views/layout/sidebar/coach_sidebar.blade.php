		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							...
							<img alt="user-img" class="avatar avatar-xl brround" src="{{asset('uploads/coaches_photo')."/".auth('coach')->user()->photo }}" ><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
                            @if(Auth::guard('coach')->check())
                            	<h4 class="font-weight-semibold mt-3 mb-0">{{Auth::guard('coach')->user()->name}}</h4>
							    <span class="mb-0 text-muted">{{Auth::guard('coach')->user()->email}}</span>
                            @endif
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ route('coach.index') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">{{trans('admin.home')}}</span></a>
					</li>


					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{ trans('admin.appointments') }}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('coach.appointment.index') }}">{{ trans('admin.available_appointments') }}</a></li>
							<li><a class="slide-item" href="{{ route('coach.appointment.create') }}">{{ trans('admin.create_appointment') }}</a></li>
						</ul>
					</li>
					{{-- <li class="slide">
                    ...
                    <li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('coach.category.index')}}">{{trans('admin.categories_list')}}</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('coach.service.index')}}">{{trans('admin.services_list')}}</a></li>
							<li><a class="slide-item" href="{{ route('coach.service.create')}}">{{trans('admin.create_service')}}</a></li>
						</ul>
					</li>


					<li class="slide">
						<a class="side-menu__item" href="{{ route('coach.review.index') }}">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('coach.edit_profile') }}">{{trans('admin.update_profile')}}</a></li>
							<li><a class="slide-item" href="{{ route('coach.certificates') }}">{{ trans('admin.certificates') }}</a></li>
						</ul>
					</li>
					{{-- <li class="slide ">
                    ...
                    <li class="slide">
						<a class="side-menu__item" href="#"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
							<svg style="color:#8992a5;" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg><span class="side-menu__label"> <span class="mx-3">{{trans('admin.logout')}}</span></span>
						</a>
					</li>
